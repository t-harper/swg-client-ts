...
describe('InventoryView', () => {
  ...
  describe('game-stage auto-open wire send', () => {
    it('fires ClientOpenContainerMessage(playerNetworkId, "inventory") once per zone-in', async () => {
      ...
      // Find the ClientOpenContainerMessage we sent during auto-open.
      const opens = sent.filter(
        (m): m is ClientOpenContainerMessage => m instanceof ClientOpenContainerMessage,
      );
