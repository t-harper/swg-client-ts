...
interface InternalContext extends ScriptContext {
  ...
  readonly _state: {
    ...
    /**
     * Per-player bazaar-browse request id. Auto-incremented each
     * `ctx.browseBazaar()` call so concurrent in-flight browses can be
     * disambiguated by inspecting `AuctionQueryHeadersResponseMessage.requestId`.
     */
